...
First, we’re pleased to be partnering exclusively with [**SwapX**](https://swapx.fi/swap) to deliver initial liquidity pools from April 9th onwards. SwapX will be delivering gauges from the get-go, boosting yields with additional GEMSx rewards. Beefy’s treasury will seed the pools with a small amount of liquidity, with weekly bribes to incentivize additional providers. The core operational pool will be [*USDC.e/beS*](https://swapx.fi/earn?orderBy=totalValueLockedUSD&orderDirection=desc&orderByCore=totalValueLockedUSD&orderDirectionCore=desc&search=beS%2FUSDC.e), charging a 0.01% fee for swaps. What’s more, we will buddy up with [**Origin Protocol**’s *oS* LST](https://www.originprotocol.com/os) for a 0.01% [*beS/oS*](https://swapx.fi/earn?orderBy=totalValueLockedUSD&orderDirection=desc&orderByCore=totalValueLockedUSD&orderDirectionCore=desc&search=beS%2Fos) pair that’s stacked with co-bribes and additional incentives. 👀

Then, from April 16th onwards, beS enters the next phase of its rollout, arriving on [**Shadow Exchange**](https://www.shadow.so/), [**DeFive**](https://defive.com/swap), and [**Beets**](https://beets.fi/swap/). For all three, we’ll be delivering standard *beS/S* liquidity pools with gauges, supported by initial bribe commitments as needed. For Shadow and DeFive, we’ll also be launching *beS/USDC.e* pools in much the same way. But on Beets, we’ll be pairing beS with our popular [Silo USDC.e vault](https://app.beefy.com/vault/silov2-sonic-usdce-ws) for the wS lending market, which averages ~5% in stable yield on USDC.e deposits.
