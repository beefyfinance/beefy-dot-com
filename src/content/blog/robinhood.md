...
header_image: "../../images/blog/robinhood/cover.png"
short_description: "Beefy launches on Robinhood Chain with Uniswap CLM vaults, bringing automated liquidity management to mainstream users and helping democratize finance for all."
sub_header: "Robinhood: Bringing Mainstream Finance Onchain"
title: "Robinhood: Bringing Mainstream Finance Onchain"
tags: [products]
---
...
Already, Robinhood is showing that the idea has legs: the chain has reached $275 million in TVL in under 3 weeks, with over half a billion in daily DEX volume. The Robinhood USDG vault on [Morpho](https://app.morpho.org/robinhood-chain/vault/0xBeEff033F34C046626B8D0A041844C5d1A5409dd/steakhouse-usdg#overview), curated by Steakhouse, has already surpassed $150 million in deposits, backed up by incentives for Robinhood Earn depositors. These are all serious signals for a young ecosystem: beyond just surveying the landscape or farming for incentives, users are putting their liquidity to work.

## Beefy on Robinhood

Beefy is launching with four Uniswap Cowcentrated Liquidity Manager (CLM) vaults:

- [Uniswap WETH-USDG CLM](https://app.beefy.com/vault/uniswap-cow-robinhood-weth-usdg-rp)
- [Uniswap CASHCAT-WETH CLM](https://app.beefy.com/vault/uniswap-cow-robinhood-cashcat-weth-rp)
- [Uniswap CASHCAT-USDG CLM](https://app.beefy.com/vault/uniswap-cow-robinhood-cashcat-usdg-rp)
- [Uniswap TENDIES-WETH CLM](https://app.beefy.com/vault/uniswap-cow-robinhood-tendies-weth-rp)
...
To get started, check out the [Robinhood Chain docs](https://docs.robinhood.com/chain/) and [ecosystem page](https://robinhood.com/us/en/chain/ecosystem/) to get familiar with the network. Robinhood Chain uses ETH for gas, and the [Robinhood Chain Blockscout explorer](https://robinhoodchain.blockscout.com/) is there when you want to check balances, transactions and contracts.

To bridge in, the [Arbitrum Portal](https://portal.arbitrum.io/bridge) is the official route. [Stargate](https://stargate.finance/), [Across](https://across.to/) and [Relay](https://relay.link/) provide additional routes, while [Oku](https://oku.trade/), [Jumper](https://jumper.xyz/) and [Bungee](https://www.bungee.exchange/) can compare supported bridge options and pricing.

Once you have assets and ETH for gas, you can find liquidity on established DeFi protocols like [Uniswap](https://uniswap.org/) and [Curve](https://www.curve.finance/). Or check out native DEXs like [Up](https://up33.xyz/trade) and [Swaphood](https://www.swaphood.finance/) for bonus incentives and emissions as they begin their liquidity bootstrapping. [KyberSwap](https://kyberswap.com/), [1inch](https://1inch.com/swap) and Oku can help route swaps across available liquidity. 

Once you're up and running with assets and positions, it's time to head to the [Beefy app](https://app.beefy.com/) to have your positions managed for you with our range of CLM products.

## Bringing Mainstream Finance Onchain
...
[Robinhood Docs](https://docs.robinhood.com/chain/) | [Robinhood Ecosystem](https://robinhood.com/us/en/chain/ecosystem/) | [Robinhood Explorer](https://robinhoodchain.blockscout.com/) | [Beefy App](https://app.beefy.com/)
