...
header_image: "../../images/blog/v2v/cover.png"
short_description: "Introducing Vault-to-Vault Zaps, helping users move capital fluidly across chains and protocols with Beefy in just one click."
sub_header: "Vault-to-Vault Zaps: Capital In Motion"
title: "Vault-to-Vault Zaps: Capital In Motion"
tags: [products]
---

![](../../images/blog/v2v/cover.png)
...
For example, as part of the ongoing preparations for the Aero launch in July, Beefy has been collaborating on a campaign to migrate our user positions from old Slipstream products to the new protocol's design. With V2V, we now offer a Migration Module on the vault page for affected products, providing users with a route to their new replacement. The Migration Module is live now for impacted Aerodrome and Velodrome products, and will become a fixture for similar changes in the future. We're also pleased to announce that we'll be turbocharging its debut with our first V2V incentive campaign:

![](../../images/blog/v2v/workflow.mp4)
...
The initial promotion covers a range of Aerodrome, Velodrome and PancakeSwap products across Base and OP Mainnet:

* For the **Aero migration**, 13 migration routes across Aerodrome and Velodrome are eligible for Free Zaps at launch. This includes a selection of blue-chip, stablecoin and other asset vaults. All remaining Aero migration products will have the V2V migration module from launch, but only the specific products marked with **Free Zap** will benefit on the migration route offered.

* For the **PancakeSwap x Base promotion**, the Free Zap applies to any Vault-to-Vault deposits from any chain into the PancakeSwap [SOL-USDC](https://app.beefy.com/vault/pancakeswap-cow-base-sol-usdc-vault), [SOL-cbBTC](https://app.beefy.com/vault/pancakeswap-cow-base-sol-cbbtc-vault) and [JitoSOL-SOL](https://app.beefy.com/vault/pancakeswap-cow-base-sol-jitosol-vault) CLMs on Base. Token-to-Vault deposits are excluded. All of these products are also currently being incentivized with USDC rewards via Merkl. The rewards are issued by Base as part of their DeFi Summer campaign, so users can benefit from multiple layers of incentives.

The Launch Campaign starts on **Friday 19 June 2026** and will continue over the coming weeks. As both the Aero launch and Base DeFi Summer campaign continue throughout the summer, we will seek to update the range of products benefiting from Free Zaps over time. We'll also be using this opportunity to test usage, analyze results and adjust Beefy's incentivization strategy.
